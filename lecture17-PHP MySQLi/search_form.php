...
// Preemptively check for errors with the connection.
// connect_errno returns an error code if there is no error. If there is no error, it will return false.
if ($mysqli->connect_errno) {
	// Display the full error message
	echo $mysqli->connect_error;
	// exit() terminates the program - No subsequent code runs.
	exit();
}

// If we get to this point, it means that there were no connection errors.
			...
			<div class="form-group row">
				...
				<div class="col-sm-9">
					<select name="genre" id="genre-id" class="form-control">
						...
						<!-- This works but the syntax is confusing. -->
						<!-- <?php
