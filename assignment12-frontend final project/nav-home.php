	<nav class="navbar navbar-expand-md navbar-custom navbar-dark">
		<div class="container-fluid">
			...
			<a class="navbar-brand ps-4 fs-4" href="#">recipage</a>
			...
			<div class="collapse navbar-collapse" id="navContent">
				<ul class="navbar-nav me-auto mb-2 mb-md-0">
					...
					<li class="nav-item">
						<a class="nav-link text-center <?php if($active_nav == "signup") { echo "active "; } ?>" aria-current="page" href="#">sign up</a>
					</li>
					<li class="nav-item">
						<a class="nav-link text-center <?php if($active_nav == "login") { echo "active "; } ?>" href="#">login</a>
					</li>
				</ul>
			</div>
		</div>
