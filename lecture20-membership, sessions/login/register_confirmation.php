...
if ( !isset($_POST['email']) || empty($_POST['email'])
	...
	// Run a SQL query to check if the users table already has this username or email address
	...
	// if num_rows is greater than 0, it means there is already a record with that username OR email
