...
// Import in the config.php file that holds all of our credentials
// To import, use either require or include keywords
// Using require means the file MUST exist and import properly, otherwise the program will not continue
// Include means that an issue with the file will just generate a warning and the code will continue
...
if (!isset($_GET["track_id"]) || empty($_GET["track_id"])) {
	...
	// Terminate the program at this point. Subsequent code does not run.
	exit();
}
...
<body>
	...
	<div class="container">
		...
		<form action="edit_confirmation.php" method="POST">
			...
			<!-- Can pass the track_id information to edit_confirmation.php by using an input tag with type hidden for POST - OR could modify the URL for the form action to append track_id, but then you need to use GET to get it -->
